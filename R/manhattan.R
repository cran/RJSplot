#create json
manhattanJSON<-function(data, assembly, axisv, distv, cell, outliers, ylab, yscale, dir){
...
return(toJSON(list(nodes = nodes, histogram = histogram, scale = assembly, yscale = yscale, axis = c(axisv,distv), yLab = ylab)))
}

#create html wrapper for manhattan plot
manhattan_rjs<-function(data, assembly = GRCh38, axisv = 0, distv = 1, cell = 1e+06, outliers = TRUE, ylab = "score", yscale = NA, plot = TRUE, jupyter = FALSE, dir = "ManhattanPlot"){
createHTML(dir, c("d3.min.js","jspdf.min.js","functions.js","manhattan.js"), manhattanJSON(data, assembly, axisv, distv, cell, outliers, ylab, yscale, dir), plot, jupyter)
}
